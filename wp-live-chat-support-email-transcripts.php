...
/*
* 1.0.1 - 29 October 2016
* Fixed bug were transcripts would not send when using cloud server
...
add_action('wplc_hook_admin_settings_main_settings_after','wplc_et_settings');
...
function wplc_et_settings() {
	$wplc_et_settings = get_option("WPLC_ET_SETTINGS");
	echo "<hr />";
	echo "<h3>".__("Chat Transcript Settings",'wp-live-chat-support-email-transcripts')."</h3>";
	echo "<table class='form-table' width='700'>";
	echo "	<tr>";
	echo "		<td width='400' valign='top'>".__("Enable chat transcripts:","wp-live-chat-support-email-transcripts")."</td>";
	echo "		<td>";
	echo "			<input type=\"checkbox\" value=\"1\" name=\"wplc_enable_transcripts\" ";
	if(isset($wplc_et_settings['wplc_enable_transcripts'])  && $wplc_et_settings['wplc_enable_transcripts'] == 1 ) { echo "checked"; }
	echo " />";
	echo "		</td>";
	echo "	</tr>";

	echo "	<tr>";
	echo "		<td width='400' valign='top'>".__("Email body","wp-live-chat-support-email-transcripts")."</td>";
	echo "		<td>";
	echo "			<textarea cols='85' rows='15' name=\"wplc_et_email_body\">";
	if(isset($wplc_et_settings['wplc_et_email_body'])) { echo html_entity_decode(stripslashes($wplc_et_settings['wplc_et_email_body'])); }
	echo " </textarea>";
	echo "		</td>";
	echo "	</tr>";
	...
	echo "	<tr>";
	echo "		<td width='400' valign='top'>".__("Email header","wp-live-chat-support-email-transcripts")."</td>";
	echo "		<td>";
	echo "			<textarea cols='85' rows='5' name=\"wplc_et_email_header\">";
	if(isset($wplc_et_settings['wplc_et_email_header'])) { echo stripslashes($wplc_et_settings['wplc_et_email_header']); }
	echo " </textarea>";
	echo "		</td>";
	echo "	</tr>";

	echo "	<tr>";
	echo "		<td width='400' valign='top'>".__("Email footer","wp-live-chat-support-email-transcripts")."</td>";
	echo "		<td>";
	echo "			<textarea cols='85' rows='5' name=\"wplc_et_email_footer\">";
	if(isset($wplc_et_settings['wplc_et_email_footer'])) { echo stripslashes($wplc_et_settings['wplc_et_email_footer']); }
	echo " </textarea>";
	echo "		</td>";
	echo "	</tr>";
